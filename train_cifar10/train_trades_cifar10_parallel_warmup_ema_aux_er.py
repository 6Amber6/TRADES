...
def main():
    ...
    transform_trades = transforms.Compose([
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
    ...
    base_train = torchvision.datasets.CIFAR10(
        root='../data', train=True, download=True, transform=transform_warmup
    )
    ...
    freeze_bn(fusion)
    # Weaken RandomErasing for TRADES stage
    base_train.transform = transform_trades
