"""PGD-20 robustness evaluation for CIFAR-100 4x25+unk routing M1 (score=1-unk)"""
...
parser = argparse.ArgumentParser(description='PGD Attack CIFAR-100 4x25+unk routing M1')
...
parser.add_argument('--route-T', type=float, default=0.2)
...
def main():
    ...
    model = UnknownRoutingFusion100(submodels, group_fine, T=route_T, margin=route_margin).to(device)
