...
# =========================================================
# Shared WRN (20 heads + unknown) for eval
# =========================================================
...
parser = argparse.ArgumentParser(description='PGD White-box Attack (CIFAR-100 Shared 20U)')
...
def main():
    # data (normalized, to match training)
    ...
    model = SharedWRN20Gate(depth=34, widen_factor=10, num_heads=20,
