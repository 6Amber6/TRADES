...
# Argument parser
# =========================================================
parser = argparse.ArgumentParser(description='PGD White-box Attack (CIFAR-10 Soft Routing + EMA)')
...
def main():
    ...
    model = SoftRoutingFusion(
        m4, m6,
        a=args.route_a, b=args.route_b, T=args.route_T, margin=args.route_margin
    ).to(device)
    ...
    model.eval()
    print('PGD white-box attack (CIFAR-10 soft routing)')
