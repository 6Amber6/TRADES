"""
AutoAttack evaluation for CIFAR-100 4x25+unk routing M1 (unk_routing_m1_v2.py).
...
def main():
    parser = argparse.ArgumentParser(description='AutoAttack eval – CIFAR-100 4x25+unk M1')
    ...
    parser.add_argument('--route-T', type=float, default=0.5, help='routing T (must match training route-T-end)')
    ...
    fusion = UnknownRoutingFusion100(submodels, group_fine, T=route_T).to(device)
    ...
    if args.log_path is None:
        ...
        args.log_path = os.path.join(model_dir, 'log-aa-4x25-unk-m1-v2.log')
