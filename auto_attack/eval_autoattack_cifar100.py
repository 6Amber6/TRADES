"""
AutoAttack evaluation for TRADES CIFAR-100 model.
Usage: pip install autoattack
       python auto_attack/eval_autoattack_cifar100.py --model-path ./model-cifar100-wideResNet/model-wideres-epoch120.pt
"""
...
parser = argparse.ArgumentParser(description='AutoAttack evaluation for TRADES CIFAR-100')
parser.add_argument('--model-path', required=True, help='path to model checkpoint')
parser.add_argument('--data-dir', default='../data', help='CIFAR-100 data directory')
...
# Data (no normalization - TRADES CIFAR-100 uses raw [0,1])
...
# Model
model = WideResNet(depth=34, widen_factor=10, num_classes=100).to(device)
...
if args.log_path is None:
    ...
    args.log_path = os.path.join(model_dir, 'log-aa-cifar100.log')
...
print('Running AutoAttack evaluation on CIFAR-100...')
